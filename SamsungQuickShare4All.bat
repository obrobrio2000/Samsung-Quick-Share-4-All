...
regedit /s "powershell.exe "(new-object System.Net.WebClient).DownloadFile('https://github.com/obrobrio2000/Samsung-Quick-Share-4-All/releases/download/v0.1.0/DriverCheckBypass.reg','DriverCheckBypass.reg'); rm DriverCheckBypass.reg -r -f""
